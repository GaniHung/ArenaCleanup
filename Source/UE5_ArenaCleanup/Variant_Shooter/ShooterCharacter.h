 ...
 */
UCLASS(abstract)
class UE5_ARENACLEANUP_API AShooterCharacter : public AUE5_ArenaCleanupCharacter, public IShooterWeaponHolder
{
	GENERATED_BODY()
...
protected:
	...
	/** Current HP remaining to this character (server authoritative, replicated) */
