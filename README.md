...
竞技场·肃清行动 是一款使用 Unreal Engine 5.7 制作的第一人称合作竞技场射击游戏。
...
[观看联机双视角联机演示（MP4，约 171 MiB）](https://github.com/GaniHung/UE5_ArenaCleanup/releases/download/v1.0.0/Dual-Camera-Demo.mp4)
...
<p align="center">
  <img src="docs/images/cover.jpg" alt="Arena Cleanup interface" width="72%">
</p>
<p align="center">
  <img src="docs/images/gameplay.jpg" alt="Arena Cleanup gameplay" width="48%">
</p>
...
项目规模不大，但完整覆盖了从玩法设计、功能实现、联机测试到独立构建的过程。
...
Although relatively small in scope, the project covers the complete process from gameplay planning and implementation to multiplayer testing and packaging.
